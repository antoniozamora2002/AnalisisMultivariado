...
library(stringr)
library(data.table)
resultados2014 = read_delim("C:/Users/HP/OneDrive/Documentos/Sesion 01/resultados2014.csv", 
                            ",", escape_double = FALSE, trim_ws = TRUE)

head(resultados2014)

resultados2018 = read_delim("C:/Users/HP/OneDrive/Documentos/Sesion 01/resultados2018.csv", 
                            ",", escape_double = FALSE, trim_ws = TRUE) 
head(resultados2018) 
...
# ¿Cómo varió el porcentaje de votos obtenidos por el Partido?
...
library("dplyr")
library(geojsonsf)
codigohasc = read_excel("C:/Users/HP/OneDrive/Documentos/Sesion 01/codigohasc2.xlsx")
View(codigohasc)
